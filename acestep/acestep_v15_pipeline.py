...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="ACE-Step V1.5 Portable",
    ...
    parser.add_argument("--offload_dit_to_cpu", type=lambda x: x.lower() in ['true', '1', 'yes'], default=True, help="Offload DiT to CPU (default: True)")
    ...
    parser.add_argument("--download-source", type=str, default="huggingface", choices=["huggingface", "modelscope", "auto"], help="Preferred model download source (default: auto-detect based on network)")
