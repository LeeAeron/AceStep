...
MODEL_REPO_MAPPING = {
    ...
    "acestep-v15-turbo": "LeeAeron/Ace-Step1.5",
    "acestep-5Hz-lm-1.7B": "LeeAeron/Ace-Step1.5",
    "vae": "LeeAeron/Ace-Step1.5",
    "Qwen3-Embedding-0.6B": "LeeAeron/Ace-Step1.5",
...
DEFAULT_REPO_ID = "LeeAeron/Ace-Step1.5"
...
def _download_from_huggingface(repo_id: str, local_dir: str, model_name: str) -> str:
    ...
    is_unified_repo = repo_id == DEFAULT_REPO_ID or repo_id == "LeeAeron/Ace-Step1.5"
    ...
    async def lifespan(app: FastAPI):
        ...
        if no_init:
            ...
            if offload_to_cpu_env is not None:
                offload_to_cpu = _env_bool("ACESTEP_OFFLOAD_TO_CPU", True)
            else:
                offload_to_cpu = auto_offload
                if auto_offload:
                    print("[API Server] Auto-setting offload_to_cpu=True based on GPU memory")

            offload_dit_to_cpu = _env_bool("ACESTEP_OFFLOAD_DIT_TO_CPU", True)
