...
GPU_TIER_CONFIGS = {
    "tier1": {  # <= 4GB
        ...
        "quantization_default": False,  # INT8 essential to fit DiT in ~4GB
    ...
    "tier5": {  # 12-16GB
        ...
        "recommended_backend": "pt",
        "offload_to_cpu_default": True,
        "offload_dit_to_cpu_default": True,  # 12-16GB can keep DiT on GPU
        "quantization_default": False,
        "compile_model_default": True,
        "lm_memory_gb": {"0.6B": 3, "1.7B": 8, "4B": 12},
    },
    ...
    "tier6b": {  # 20-24GB (e.g., RTX 3090, RTX 4090)
        ...
        "lm_backend_restriction": "all",
        "recommended_backend": "pt",
        "offload_to_cpu_default": True,  # 20-24GB can hold all models
        "offload_dit_to_cpu_default": True,
