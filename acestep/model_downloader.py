...
def _download_from_huggingface_internal(
    ...
    Args:
        repo_id: HuggingFace repository ID (e.g., "LeeAeron/Ace-Step1.5")
...
MAIN_MODEL_REPO = "LeeAeron/Ace-Step1.5"

# Sub-models that can be downloaded separately into the checkpoints directory
SUBMODEL_REGISTRY: Dict[str, str] = {
    # LM models
    "acestep-5Hz-lm-0.6B": "LeeAeron/acestep-5Hz-lm-0.6B",
    "acestep-5Hz-lm-4B": "LeeAeron/acestep-5Hz-lm-4B",
    # DiT models
    "acestep-v15-turbo-shift3": "LeeAeron/acestep-v15-turbo-shift3",
    "acestep-v15-sft": "LeeAeron/acestep-v15-sft",
    "acestep-v15-base": "LeeAeron/acestep-v15-base",
    "acestep-v15-turbo-shift1": "LeeAeron/acestep-v15-turbo-shift1",
    "acestep-v15-turbo-continuous": "LeeAeron/acestep-v15-turbo-continuous",
}

# Components that come from the clone main model repo (LeeAeron/Ace-Step1.5)
...
Alternative using huggingface-cli:
  huggingface-cli download LeeAeron/Ace-Step1.5 --local-dir ./checkpoints
  huggingface-cli download LeeAeron/acestep-5Hz-lm-0.6B --local-dir ./checkpoints/acestep-5Hz-lm-0.6B
        """
    )
