...
def build_lora_dataset_and_adapter_controls(tensor_output_dir: str = None) -> dict[str, object]:
    ...
    # Resolve the path (use the passed or default one)
    ...
    with gr.Row():
        with gr.Column(scale=2):
            ...
            training_tensor_dir = gr.Textbox(
                ...
                value=resolved_path,  # Use the permitted path
